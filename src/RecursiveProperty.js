...
const test = (property, propertyKeys, propertyName, propertyPath) => {
  ...
  if (
    ...
    return (
      <React.Fragment key={property.naam}>
        <div>
          <Row
            style={{ border: '1px solid blue', borderLeft: '3px solid blue' }}
          >
            <Cell>naam</Cell>
  ...
  if (checkArrayOfStrings(property)) {
    return (
      <Row style={{ border: '1px solid red', borderLeft: '3px solid  red' }}>
...
const check = (property, propertyName, propertyPath) => {
  if (
    ...
    return (
      <Row
        style={{ border: '1px solid orange', borderLeft: '3px solid  orange' }}
      >
        <Cell>{propertyName}</Cell>
